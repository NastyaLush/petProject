...
public class UserServiceImpl implements UserService {
    ...
    public List<Album> getAlbumsByUserId(Long userId) {
        return webClient.get()
                .uri(uriBuilder -> uriBuilder.path("/{id}/albums").build(userId))
                .retrieve()
    ...
    public List<Todo> getTodosByUserId(Long userId) {
        return webClient.get()
                .uri(uriBuilder -> uriBuilder.path("/{id}/todos").build(userId))
                .retrieve()
    ...
    public List<Post> getPostsByUserId(Long userId) {
        return webClient.get()
                .uri(uriBuilder -> uriBuilder.path("/{id}/posts").build(userId))
                .retrieve()
